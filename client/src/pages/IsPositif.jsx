...
function IsPositif() {
    ...
    const blockChainInfo = BlockChainInfos(IsPositifContract);

    async function handleIsPositif() {
        if (!blockChainInfo.contract) return;

        const isPositive = await blockChainInfo.contract.methods.isPositif(number).call();
        setResult(isPositive ? "Le nombre est positif" : "Le nombre n'est pas positif");
    }
        ...
        <>
            <div className="ex-page">
                <header className="ex-header">
                    ...
                    <h1 className="ex-title">Exercice 4 · Nombre positif</h1>
                    <span className="ex-filename">IsPositif.sol</span>
                </header>
                    ...
                    <div className="ex-left">
                        ...
                        <section className="ex-section">
                            ...
                            <div className="ex-fn-row">
                                <button className="ex-fn-btn ex-fn-btn--pure"
                                    onClick={handleIsPositif}
                                >
                                    <span className="ex-badge ex-badge--pure">pure</span> isPositive()
                                </button>
                            </div>
                        ...
                        <section className="ex-section">
                            ...
                            <div className="ex-ref-row">
                                ...
                                <span className="ex-ref-desc">Vérifie si un nombre est positif</span>
                            </div>
                        </section>
                    </div>
